/**This gets a list of table comments from the um.... unusual way that MSSQLSERVER likes to store them
   --Dave Babler*/
DECLARE @TableName VARCHAR;

SET @TableName = '';--you fill in between the quotes!!!
...
WHERE tbl.TABLE_NAMktE = @TableName
